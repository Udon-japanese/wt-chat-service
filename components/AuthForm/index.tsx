...
export default function Authenticate(texts: AuthText) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="min-h-screen w-full bg-gray-100 px-4 py-28 dark:bg-gray-900">
        <div className="flex flex-col items-center justify-center">
          <div className="mt-16 w-full rounded-lg bg-white p-10 border border-gray-400 dark:border-gray-500 dark:bg-gray-700 md:w-1/2 lg:w-1/3">
            ...
            <span className="flex items-center justify-center mt-5">
              <p className="whitespace-pre truncate text-sm font-medium leading-none text-gray-500 dark:text-gray-300">
                {texts.subhead.p}&nbsp;
              </p>
              <Link
                className="cursor-pointer truncate whitespace-pre rounded px-1 py-1.5 text-sm font-medium leading-none text-blue-600 no-underline hover:bg-blue-400 hover:bg-opacity-10 dark:text-blue-500"
